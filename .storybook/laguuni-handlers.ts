...
import addToBasketFixture from '../tests/fixtures/laguuni/booking/add-to-basket-success.json'
import basketFixture from '../tests/fixtures/laguuni/booking/basket.json'
...
import checkoutSuccessFixture from '../tests/fixtures/laguuni/booking/checkout-success.json'
import completeOrderCashreturnFixture from '../tests/fixtures/laguuni/booking/complete-order-cashreturn.json'
import discountAcceptedFixture from '../tests/fixtures/laguuni/booking/discount-accepted.json'
import discountInvalidFixture from '../tests/fixtures/laguuni/booking/discount-invalid.json'
import orderSuccessDetailsFixture from '../tests/fixtures/laguuni/booking/order-success-details.json'
...
const storybookBasketStateByToken = new Map<string, BasketState>()
  ...
  return [
    ...
    http.get(
      ...
      ({ request }) => {
        ...
        return HttpResponse.json({
          redirectUrl: DEFAULT_PAYMENT_REDIRECT_URL,
        })
      },
    ),
    http.post(
    ...
    http.delete(
      ...
      ({ params }) => {
        storybookBasketStateByToken.delete(String(params.basketToken))
...
export function resetStorybookLaguuniHandlerState() {
  storybookBasketStateByToken.clear()
}
...
function getBasketState(basketToken: string): BasketState {
  const existingState = storybookBasketStateByToken.get(basketToken)
  ...
  storybookBasketStateByToken.set(basketToken, nextState)
