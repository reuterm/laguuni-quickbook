...
Manual verification on iOS will cover deployed Safari and the installed PWA because automated DOM tests cannot assert which native overlay WebKit presents.
